...
GAME_DATETIME = datetime(2025, 12, 25, 22, 0)

PAYMENT_TEXT = (
    "Ты зарегистрирован на игру в волейбол 25 декабря\n\n"
    "Как добраться:\n"
    ...
    "Сбербанк / Т-Банк\n\n"
    "Ссылка для оплаты:\n"
    "https://messenger.online.sberbank.ru/sl/ntAIHqCAtkFYsqsDJ\n\n"
    "После оплаты нажми кнопку ниже."
)

REMINDER_TEXT = (
    "Напоминание\n"
    "Игра в волейбол состоится завтра в 22:00.\n"
    "Адрес: просп. Маршала Жукова, 4, стр. 2, Москва"
)
